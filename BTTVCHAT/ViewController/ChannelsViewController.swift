...
class ChannelsViewController: UIViewController {
    ...
    var channelsAPIURLStringTemplate0 = "https://api.twitch.tv/kraken/streams?limit=50&stream_type=live&offset=0"
    var channelsAPIURLStringTemplate1 = "https://api.twitch.tv/kraken/streams?limit=75&stream_type=live&offset="
    var offset = 0
    let offsetInc = 50
    let overlap = 25
